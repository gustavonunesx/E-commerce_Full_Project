      ...
      <div className="relative z-10 container mx-auto px-6 pt-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-background/90 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up animation-delay-200">
            Tradição de família desde 1986. Pastéis crocantes, recheios generosos 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-300">
            ...
            <a
              ...
              className="flex items-center gap-2 px-8 py-4 border-2 border-background/50 rounded-full text-background backdrop-blur-sm transition-all duration-300 hover:bg-background hover:text-secondary"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12 animate-fade-in-up animation-delay-500">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-background/10 backdrop-blur-sm rounded-full px-5 py-3 hover:bg-background/20 transition-colors cursor-pointer"
            >
              <MapPin className="w-5 h-5 text-primary" />
              <span className="text-background text-sm">Av. Bruno Ruggiero Filho, 1115</span>
            </a>
