...
const stats = [
  { icon: Award, value: "40+", label: "Anos de Tradição" },
  { icon: Users, value: "50K+", label: "Clientes Satisfeitos" },
  { icon: Coffee, value: "100K+", label: "Pastéis Vendidos" },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="bg-primary rounded-2xl p-6 text-primary-foreground">
                  <p className="font-serif text-3xl font-bold">1985</p>
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Começamos como uma pequena barraquinha na feira do bairro. Seu Zé, 
                nosso fundador, aprendeu a receita secreta da massa com sua avó 
                portuguesa e desde então mantemos a mesma dedicação e carinho em 
                cada pastel que fazemos.
              </p>
              <p>
